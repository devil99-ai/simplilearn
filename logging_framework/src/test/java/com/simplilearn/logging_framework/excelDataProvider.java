	...
	public void test1(String url) throws InterruptedException {
	       ...
	       //logger = extent.startTest("Validate pizzahutCheckout Application Using Selenium testNG");
			...
			try{
			    ...
			    this.takeSnapShot(driver, "screenshotStore/webpage.png");
			}catch(Exception e) {
				test1.log(Status.FAIL,"not able to open pizzahut webpage");
			}
...
//		else{
			try{
				...
				this.takeSnapShot(driver, "screenshotStore/location_typing.png");
			}catch(Exception e) {
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/deals.png");
			} catch (Exception e) {
				e.printStackTrace();
		...
		//selecting pizza
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/pizza_tab.png");
			} catch (Exception e) {
				e.printStackTrace();
...
//			System.out.println(price);
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/successfully_added_pizza.png");
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/drinks_tab.png");
			} catch (Exception e) {
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/1st_drinks_added.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/2nd_drinks_added.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/payment_page.png");
			} catch (Exception e) {
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/radio-button.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/checkbox_checked.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/details_filled.png");
			}catch(Exception e) {
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/giftCard.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try {
				...
				this.takeSnapShot(driver, "screenshotStore/popUp.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try {
				...
				test1.pass("successfuly click on voucher and submit code");
				this.takeSnapShot(driver, "screenshotStore/voucherSubmitting.png");
			} catch (Exception e) {
				// TODO: handle exception
			...
			try{//validating error
				...
				this.takeSnapShot(driver, "screenshotStore/errorVoucherCode.png");
			}catch(Exception e) {
			...
			try{//close pop up
				...
				this.takeSnapShot(driver, "screenshotStore/paymentPage2.png");
			}catch(Exception e) {
			...
			try{//user navigate to basket page
				...
				this.takeSnapShot(driver, "screenshotStore/MyBasket.png");
			}catch(Exception e) {
